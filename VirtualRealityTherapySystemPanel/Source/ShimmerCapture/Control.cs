...
namespace ShimmerAPI
{
    public partial class Control : Form
    {
        ...
        //PPG-HR
        public static PPGToHRAlgorithm PPGtoHeartRateCalculation;
        private Boolean EnablePPGtoHRConversion = true;
        private int NumberOfHeartBeatsToAverage = 10;
        private int NumberOfHeartBeatsToAverageECG = 1;
        private int TrainingPeriodPPG = 7; //5 second buffer
        ...
        Filter NQF_Exg2Ch1;
        Filter NQF_Exg2Ch2;
        public Filter LPF_PPG;
        public Filter HPF_PPG;
        Filter HPF_Exg1Ch1;
        Filter HPF_Exg1Ch2;
        Filter HPF_Exg2Ch1;
        Filter HPF_Exg2Ch2;
        ...
        //public double Doconversion(double a13)
        //{
        ...
        public void AutoConnect()
        {
            ...
            {
                while (ShimmerDevice.GetState() == Shimmer.SHIMMER_STATE_CONNECTING)
                    System.Threading.Thread.Sleep(5000);
                System.Diagnostics.Debug.WriteLine(ShimmerDevice.GetState());
        ...
        private void ControlForm_Load(object sender, EventArgs e)
        {
            ...
            Thread threadA = new Thread(new ThreadStart(AutoConnect));
            threadA.Start();
        }
