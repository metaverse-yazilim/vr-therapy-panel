angular.module('vrTheraphy').controller('amfi100settings_controller', ['$scope', '$http', '$state', '$stateParams', '$localStorage', '$sessionStorage', '$rootScope', '$uibModal', 'srvSessionsettings',
    function ($scope, $http, $state, $stateParams, $localStorage, $sessionStorage, $rootScope, $uibModal, srvSessionsettings) {
        ...
        $scope.amfi100 = function (settingsForm) {
            if (($scope.availables + $scope.availablen + $scope.availableu + $scope.availabler < 105)) {
                ...
                var promiseGet = srvSessionsettings.amfi100(settingsForm);
