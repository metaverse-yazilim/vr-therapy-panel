angular.module('vrTheraphy').controller('sessionliveacint_controller', ['$scope', '$http', '$state', '$stateParams', '$localStorage', '$sessionStorage', '$rootScope', '$uibModal', '$interval', 'srvSessionlive', '$window',
    function ($scope, $http, $state, $stateParams, $localStorage, $sessionStorage, $rootScope, $uibModal, $interval, srvSessionlive, $window) {
        ...
        $scope.clickall = function () {
            if ($scope.firstperson != 0 && $scope.secondperson != 0 && $scope.thirdperson != 0) {
        ...
        //Sorular BAŞLANGIÇ
        $scope.question000 = function () {
            $scope.finalform.question = "000";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
        ...
        $scope.question001 = function () {
            $scope.finalform.question = "001";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question002 = function () {
            $scope.finalform.question = "002";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question003 = function () {
            $scope.finalform.question = "003";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question004 = function () {
            $scope.finalform.question = "004";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question005 = function () {
            $scope.finalform.question = "005";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
