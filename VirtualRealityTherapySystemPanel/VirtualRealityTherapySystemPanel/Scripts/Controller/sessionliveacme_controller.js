angular.module('vrTheraphy').controller('sessionliveacme_controller', ['$scope', '$http', '$state', '$stateParams', '$localStorage', '$sessionStorage', '$rootScope', '$uibModal', '$interval', 'srvSessionlive', '$window',
    function ($scope, $http, $state, $stateParams, $localStorage, $sessionStorage, $rootScope, $uibModal, $interval, srvSessionlive, $window) {
        ...
        //Sorular BAŞLANGIÇ
        $scope.question012 = function () {
            $scope.finalform.question = "012";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
        ...
        $scope.question013 = function () {
            $scope.finalform.question = "013";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question014 = function () {
            $scope.finalform.question = "014";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question015 = function () {
            $scope.finalform.question = "015";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question039 = function () {
            $scope.finalform.question = "039";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question040 = function () {
            $scope.finalform.question = "040";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question041 = function () {
            $scope.finalform.question = "041";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question057 = function () {
            $scope.finalform.question = "057";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question058 = function () {
            $scope.finalform.question = "058";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question059 = function () {
            $scope.finalform.question = "059";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.datacheck = function () {
            var promiseGet = srvSessionlive.data($scope.finalform);
            promiseGet.then(function (result) {
                delete $scope.$storage.data2;
                delete $scope.data2;
                $scope.$storage = $sessionStorage.$default({
                    data2: result.data
                });
                $scope.data2 = $scope.$storage.data2;
                graph2.series[0].data = $scope.data2;
                graph2.update();
            });
        };

        //SORU TABLARINI AYARLAMA
        ...
        //$scope.datadisconnect = function () {
        //    var promiseGet = srvSessionlive.datadisconn($scope.finalform);
        //};
