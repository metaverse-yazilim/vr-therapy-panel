angular.module('vrTheraphy').controller('ac_int_settings_controller', ['$scope', '$http', '$state', '$stateParams', '$localStorage', '$sessionStorage', '$rootScope', '$uibModal', 'srvSessionsettings',
    function ($scope, $http, $state, $stateParams, $localStorage, $sessionStorage, $rootScope, $uibModal, srvSessionsettings) {
        ...
        $scope.change1 = function () {
            ...
            if (elem.value == "T") {
                ...
                if (elem2.value == "T" || elem3.value == "T") {
                    elem.value = "K";
                    $scope.settings.koltuk1 = "K";
                }
                else {
        ...
        $scope.acint = function (settingsForm) {
            if ($scope.form.$valid) {
                if ((settingsForm.koltuk1 != 'B') || (settingsForm.koltuk2 != 'B') || (settingsForm.koltuk3 != 'B')) {
                    if ($scope.availablen + $scope.availableu + $scope.availables + $scope.availabler == $scope.available) {
                        ...
                        var promiseGet = srvSessionsettings.acint(settingsForm);
