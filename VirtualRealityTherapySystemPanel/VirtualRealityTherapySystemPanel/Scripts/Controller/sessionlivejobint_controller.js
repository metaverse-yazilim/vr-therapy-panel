angular.module('vrTheraphy').controller('sessionlivejobint_controller', ['$scope', '$http', '$state', '$stateParams', '$localStorage', '$sessionStorage', '$rootScope', '$uibModal', '$interval', 'srvSessionlive', '$window',
    function ($scope, $http, $state, $stateParams, $localStorage, $sessionStorage, $rootScope, $uibModal, $interval, srvSessionlive, $window) {
        ...
        //Sorular BAŞLANGIÇ
        $scope.question006 = function () {
            $scope.finalform.question = "006";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
        ...
        $scope.question007 = function () {
            $scope.finalform.question = "007";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question008 = function () {
            $scope.finalform.question = "008";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question009 = function () {
            $scope.finalform.question = "009";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question010 = function () {
            $scope.finalform.question = "010";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question011 = function () {
            $scope.finalform.question = "011";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 10;
        ...
        $scope.question036 = function () {
            $scope.finalform.question = "036";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question037 = function () {
            $scope.finalform.question = "037";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question038 = function () {
            $scope.finalform.question = "038";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question054 = function () {
            $scope.finalform.question = "054";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question055 = function () {
            $scope.finalform.question = "055";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
        ...
        $scope.question056 = function () {
            $scope.finalform.question = "056";
            $scope.finalform.initial = "2";
            if ($scope.isDisabled == 0) {
                $scope.isDisabled = 1;
                $scope.disabled_time = 5;
