...
//    public static void Save(string filename, List<byte> clip, bool trim = false)
//    {
...
//        var filepath = Path.Combine("../Audio/", filename);
...
//    public static byte[] GetWav(List<byte> clip, out uint length, bool trim = false)
//    {
//        uint samples;
...
//    private static byte[] ConvertAndWrite(List<byte> clip, out uint length, out uint samplesAfterTrimming, bool trim)
//    {
//        var sampleCount = clip.Count;
...
//            {
//                if ((short)(clip[i] * RescaleFactor) == 0)
//                    continue;
...
//        {
//            var value = (short)(clip[i] * RescaleFactor);
...
//    private static void WriteHeader(byte[] stream, List<byte> clip, uint length, uint samples)
//    {
//        var hz = (uint)AudioSettings.outputSampleRate; //clip.frequency;
//        var channels = (ushort)2; //clip.channels;
