...
{
    public class AcmesettingsController : ApiController
    {
        public HttpResponseMessage Post(dynamic formData)
        {
            try
            {
                ...
                string avatar5 = "";
                string avatar6 = "";
                string place = "Akademik Toplantı";
                string initial = "4";
                ...
                {
                    randomnumber = random.Next(0, e);
                    avatar5 = Convert.ToString((avatarlist[randomnumber] + 9));
                    if (avatar5 == "9")
                    {
                        avatar5 = "09";
                    }
                ...
                if (koltuk6 == 'E' || koltuk6 == 'K')
                {
                    avatar6 = Convert.ToString((avatarlist[0] + 9));
                    if (avatar6 == "9")
                    {
                        avatar6 = "09";
                    }
