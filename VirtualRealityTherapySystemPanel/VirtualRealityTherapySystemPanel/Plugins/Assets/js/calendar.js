    ...
    $(document).ready(function() {
        ...
        $('#myCalendar').pagescalendar({
            ...
            events: [{
                ...
                start: moment().startOf('week').add(1, 'days').add(10, 'hours').format(),
                end: moment().startOf('week').add(1, 'days').add(12, 'hours').format(),
                other: {
                ...
                start: moment().startOf('week').add(2, 'days').add(14, 'hours').format(),
                end: moment().startOf('week').add(2, 'days').add(15, 'hours').format(),
                other: {
                    //You can have your custom list of attributes here
                    note: 'test'
                }
                ...
                start: moment().startOf('week').add(2, 'days').add(15, 'hours').format(),
                end: moment().startOf('week').add(2, 'days').add(16, 'hours').format(),
                other: {
                    //You can have your custom list of attributes here
                    note: 'test'
                }
